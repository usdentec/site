...
<div id="template_wrapper">
		<div id="template_header" class="">
			<b id="banner">Welcome to my Portfolio & Web Application</b><img id="pic" src="img/usman.jpg"></img>
		</div>
	<div id="navigation">
	    <?php
	    if (loggedin()){
		...
		<div id="l1" class="mvcorm"><a href="mvcorm.php">PHP: MVCs<img src="img/construction10.png"></img></a></div> 
